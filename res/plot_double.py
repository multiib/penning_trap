...
plt.plot(M[:,1,x],M[:,1,y], '-', color='#8b8229', linewidth=2.0, alpha=0.8, label = "Particle 1")
...
plt.plot(I[:,1,x],I[:,1,y], '-', color='#8b8229', linewidth=2.0, alpha=0.8, label = "Particle 1")
plt.xlabel(r"x [$\mu m$]", fontsize=16)
plt.ylabel(r"y [$\mu m$]", fontsize=16)
plt.axis("equal")
plt.tight_layout()
...
plt.plot(M[:,1,x],M[:,1,vx], '-', color='#8b8229', linewidth=2.0, alpha=0.8, label = "Particle 1")
plt.xlabel(r"x [$\mu m$]", fontsize=16)
...
plt.plot(I[:,1,x],I[:,1,vx], '-', color='#8b8229', linewidth=2.0, alpha=0.8, label = "Particle 1")
plt.xlabel(r"x $\mu m$]", fontsize=16)
plt.ylabel(r"vx [$\frac{\mu m}{\mu s}$]", fontsize=16)
plt.axis("equal")
plt.tight_layout()
...
plt.plot(M[:,1,z],M[:,1,vz], '-', color='#8b8229', linewidth=2.0, alpha=0.8, label = "Particle 1")
...
plt.plot(I[:,1,z],I[:,1,vz], '-', color='#8b8229', linewidth=2.0, alpha=0.8, label = "Particle 1")
plt.xlabel(r"z [$\mu m$]]", fontsize=16)
plt.ylabel(r"vz [$\frac{\mu m}{\mu s}$]", fontsize=16)
plt.axis("equal")
plt.tight_layout()
...
ax.plot3D(M[:,1,x],M[:,1,y],M[:,1,z], '-', color='#8b8229', linewidth=2.0, alpha=0.8, label = "Particle 1")
...
ax.plot3D(I[:,1,x],I[:,1,y],I[:,1,z], '-', color='#8b8229', linewidth=2.0, alpha=0.8, label = "Particle 1")
ax.set_xlabel(r"x [$\mu m$]", fontsize=16)
ax.set_ylabel(r"y [$\mu m$]", fontsize=16)
ax.set_zlabel(r"z [$\mu m$]", fontsize=16)
plt.tight_layout()
