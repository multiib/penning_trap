...
A = pa.mat()
A.load("./res/out/re_RK4/4000.bin")
n4 = np.array(A)

A = pa.mat()
A.load("./res/out/re_RK4/8000.bin")
n8 = np.array(A)

A = pa.mat()
A.load("./res/out/re_RK4/16000.bin")
n16 = np.array(A)

A = pa.mat()
A.load("./res/out/re_RK4/32000.bin")
n32 = np.array(A)
...
plt.grid()
plt.savefig("./res/figs/plots/rel_RK4.pdf")
...
for k in range(1, 4):
	rel_err += (1/3)*np.log(delta_max[k]/delta_max[k-1])/(np.log(h[k]/h[k-1]))
print(rel_err)